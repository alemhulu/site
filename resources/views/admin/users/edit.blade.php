...
<form method="POST" action="/users/{{ $user->id }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="firstname" class="form-control" id="name" placeholder="Name..." value="{{ $user->firstname }}" required>
    </div>
    <div class="form-group">
        <label for="lastname">User Last Name</label>
        <input type="text" name="lastname" class="form-control" id="name" placeholder="Name..." value="{{ $user->lastname }}" required>
    </div>
    <div class="form-group">

...
<form method="POST" action="/users" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="firstname" class="form-control" id="name" placeholder="First Name..." value="{{ old('firstname') }}" required>
    </div>
    <div class="form-group">
        <label for="lastname">User Last Name</label>
        <input type="text" name="lastname" class="form-control" id="name" placeholder="Last Name..." value="{{ old('lastname') }}" required>
    </div>
    <div class="form-group">
